...
public class Date
{
  ...
  public int compareTo(Date anotherDate) {
    if (anotherDate.year == getYear() && anotherDate.month == getMonth() && anotherDate.day == getDay()) return 0;
    if (anotherDate.year > getYear()) return 1;
    else if (anotherDate.year == getYear() && anotherDate.month > getMonth()) return 1;
    else if (anotherDate.year == getYear() && anotherDate.month == getMonth() && anotherDate.day > getDay()) return 1;
    else return -1;
  }
